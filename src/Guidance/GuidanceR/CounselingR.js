...
export default function CounselingR({student,studentStat}) {
    const container = {
      ...
      const getRecords = async (ress) =>{
        try{
            const response= await Axios.get(`https://newback19.onrender.com/counselingRec/${studentStat.LRN}`)
        ...
        return Swal.fire({
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              setloading(true)
                try{
                    const response= await Axios.post(`https://newback19.onrender.com/counselingRec`,
                    {
                      lrn:studentStat.LRN,
                      nature:nature,
                      result:results,
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              setloading(true)
                ...
                try{
                    const response= await Axios.patch(`https://newback19.onrender.com/counselingRec`,
                    {
                      lrn:studentStat.LRN,
                      newR:recordds
                    })
