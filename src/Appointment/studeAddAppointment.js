...
export default function StudeAddAppointment({haverequest,refresh,appointmentD,load}) {
  ...
  const[dateclicked,setDateclicked] = useState('');
    ...
    const getEventss = async () =>{
            ...
            try{
              const response= await Axios.get(`https://newback19.onrender.com/getAllEvents`)
        ...
        const getLongEventss = async () =>{
          try{
            const response= await Axios.get(`https://newback19.onrender.com/longEvents`,{credentials: 'include'})
            ...
            if(haverequest){
              ...
              Swal.fire({
                ...
                timer: 1500
                    ...
                    load(true)
                    try{
                          const response= await Axios.get(`https://newback19.onrender.com/availableCal/${yearMdayFormatClick}`)
        ...
        const dateRequestednotif = monthNames[month]+` ${day} ${year}`
          Swal.fire({
              ...
              if (result.isConfirmed) {
                load(true)
                  try{
                      const response= await Axios.post(`https://newback19.onrender.com/appointment`,
                      {
                        content:toDB,
                        lrn:cUser.LRN
                      })
                          ...
                          try{
                            const response= await Axios.post(`https://newback19.onrender.com/notification`,{
                                type:'Counseling',
